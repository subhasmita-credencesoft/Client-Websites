...
export const ROOMS: RoomCategory[] = [
  {
    ...
    slug: 'premium-room',
    name: 'Premium Room',
    subtitle: 'Premium Room features a private bathroom, TV, work desk, electric kettle, wardrobe, slippers, and complimentary toiletries, offering a comfortable and relaxing stay',
    overview:
  ...
  },
  {
    ...
    slug: 'deluxe-room',
    name: 'Deluxe Room',
    subtitle: 'Deluxe Room offers a spacious and comfortable stay with a private bathroom, TV, work desk, electric kettle, wardrobe, slippers, and complimentary toiletries',
    overview:
