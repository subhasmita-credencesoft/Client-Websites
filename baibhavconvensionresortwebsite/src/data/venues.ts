...
export const VENUES: Venue[] = [
  {
    ...
    description:
      'Our flagship column-free banquet hall with premium lighting, a grand stage, and enough space for a 350-guest seated reception or a 600-guest high-energy gala.',
    features: [
  ...
  },
  {
    ...
    area: '40,000 sq. ft. manicured lawn',
    seatedCapacity: 800,
    ...
    layouts: [
      { name: 'Theater', value: '1,500' },
      { name: 'Seated Rounds', value: '800' },
