...
type PackageVariant = "resort" | "privateVilla";

type PackagePageProps = {
  variant: PackageVariant;
};

export function PackagePage({ variant }: PackagePageProps) {
  const packageContent = pageContent.packages[variant];
      ...
      <section className="py-16 md:py-20">
        <div className="container mx-auto px-4 sm:px-6">
          <div className="grid gap-10 lg:grid-cols-[1.2fr_0.8fr] lg:items-stretch">
            <div className="relative min-h-[320px] overflow-hidden rounded-3xl shadow-2xl sm:min-h-[420px]">
              <Image
                src={packageContent.image}
            ...
            <div className="grid gap-6 md:grid-cols-3 lg:grid-cols-1">
              {packageContent.highlights.map((highlight) => (
                <div key={highlight.title} className="rounded-2xl border bg-white p-6 shadow-sm md:p-8">
