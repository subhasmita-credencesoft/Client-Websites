export const VISION_MISSION = {
  manan: { label: "Manan", text: "To help people to live quality life" },
  mission: { label: "Mission", text: "Be a first choice of our guests" },
};
...
export const VALUES = [
  ...
  },
  {
    ...
    icon: `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round">
      ...
      <path d="M17 8s1 1 1 3-1 3-1 3M7 8S6 9 6 11s1 3 1 3"/>
    </svg>`,
  },
  {
    id: "faith",
