...
export const TARIFF_INTRO_TEXT = "Tariff as follows (Taxes as per Govt Regulations)";
...
export const TARIFF_MAIN_TABLE_TITLE = "Tariff for Double Occupancy";
...
export const TARIFF_DAY_PICNIC_FOOTNOTE = "*Except Holidays & Festivals";
