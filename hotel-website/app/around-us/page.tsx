  ...
  return (
    <div className="site-page">
      ...
      <CinematicParallaxBreak 
        ...
        subtitle="Everything above is within 30 min of UK's Resort. A temple walk in the morning, a waterfall in the afternoon, Imagica the next day - and a comfortable room, good food, and a pool waiting for you each evening." 
        image="https://bookonelocal.in/cdn/Water-Park-1.jpg"
        reverse={true}
      />
