    ...
    <section className="bg-white py-20 text-[#1f3c44]">
      <Container>
        <div className="grid gap-10 lg:grid-cols-[1.2fr_0.8fr]">
          <div>
            <h2 className="font-serif text-2xl">Location and info</h2>
          ...
          <div>
            <h2 className="font-serif text-2xl">Special offers</h2>
            <div className="mt-6 overflow-hidden rounded-3xl">
              <div
                className="relative h-[420px] rounded-3xl bg-cover bg-center text-white transition duration-500"
                style={{ backgroundImage: `url(${offerSlides[activeIndex].image})` }}
              >
                <div className="absolute inset-0 bg-gradient-to-t from-black/60 via-black/10 to-transparent" />
                <div className="relative flex h-full flex-col justify-end p-8 text-center">
                  ...
                  <button className="mt-6 inline-flex h-10 items-center justify-center rounded-full border border-white/40 px-6 text-xs font-semibold uppercase tracking-[0.2em]">
                    Explore offer
                  </button>
                </div>
              </div>
