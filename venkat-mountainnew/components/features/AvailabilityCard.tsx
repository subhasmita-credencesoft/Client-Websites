...
import { propertyAvailabilityConfig } from "@/data/hotelAvailability";
...
export default function AvailabilityCard({
  ...
  function handleCheckRates() {
    ...
    const params = new URLSearchParams({
      fromDate: format(checkInDate as Date, "yyyy-MM-dd"),
      toDate: format(checkOutDate as Date, "yyyy-MM-dd"),
      noOfRooms: String(propertyAvailabilityConfig.defaultRooms),
      noOfPersons: String(guests),
    });
