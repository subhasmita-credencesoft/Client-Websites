...
import { propertyAvailabilityConfig, availabilityRoomOptions } from "@/data/hotelAvailability";
...
const ROOM_OPTIONS = availabilityRoomOptions;
...
export default function HeroBookingBar() {
  ...
  function handleSubmit(event: React.FormEvent<HTMLFormElement>) {
    ...
    const params = new URLSearchParams({
      ...
      noOfPersons: String(totalGuests),
      room: selectedRoom,
    });
