      ...
      <section className="section-space bg-dark-2">
        <div className="container-shell">
          <SectionHeading
            ...
            description="The property combines studio apartments at Abalone Resort, owner-managed support, and a location that works well for couples, families, and small groups looking to stay in Arpora."
          />
