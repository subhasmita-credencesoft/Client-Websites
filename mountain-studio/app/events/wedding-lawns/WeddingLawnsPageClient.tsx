...
export function WeddingLawnsPageClient() {
  return (
    <>
      <PageHero
      ...
      <section className="section-space">
        <div className="container-shell">
          <div className="mb-12 max-w-5xl">
            <p className="eyebrow">Wedding Lawns</p>
            ...
            <p className="mt-6 max-w-4xl text-lg leading-8 text-ivory/68">
              Redwings Studio&apos;s wedding lawns provide open-air space for traditional rituals, wedding ceremonies,
              and festive celebrations with scenic surroundings and full-estate character.
            </p>
