...
export const galleryImages = [
  { src: img('Hotel Rama Hindustani front 3.jpg'), alt: 'Hotel exterior', category: 'Exterior' },
  { src: img('hotel-rama-hindustani-jaipur-Front -pic-4.avif'), alt: 'Hotel entrance', category: 'Exterior' },
  { src: img('Hotel Rama Hindustani Reception Area 1.jpg'), alt: 'Reception area', category: 'Interior' },
  { src: img('hotel-rama-hindustani-jaipur-Reception-pic-14.jpg'), alt: 'Reception lobby', category: 'Interior' },
  { src: img('hotel-rama-hindustani-jaipur-Restaurant-pic-17.jpg'), alt: 'Restaurant', category: 'Dining' },
  { src: img('hotel-rama-hindustani-jaipur-roof top-for events-pic-19.jpg'), alt: 'Rooftop venue', category: 'Events' },
  { src: img('hotel-rama-hindustani-jaipur-Galary-lift-pic-24.jpg'), alt: 'Lift lobby', category: 'Interior' },
  { src: img('hotel-rama-hindustani-jaipur-galary-pic-27.jpg'), alt: 'Gallery', category: 'Interior' },
  { src: img('hotel-rama-hindustani-jaipur-Gym-pic-12.jpg'), alt: 'Gym', category: 'Amenities' },
  { src: img('Fun Zone1.jpg'), alt: 'Fun zone', category: 'Amenities' },
  { src: img('Fun zone2.jpg'), alt: 'Fun zone', category: 'Amenities' },
  { src: img('Fun Zone3.jpg'), alt: 'Fun zone', category: 'Amenities' },
  { src: img('Fun Zone4.jpg'), alt: 'Fun zone', category: 'Amenities' },
  { src: img('hotel-rama-hindustani-jaipur-Economy room-pic-22.jpg'), alt: 'Economy room', category: 'Rooms' },
  { src: img('hotel-rama-hindustani-jaipur-Economy Room-pic-37.jpg'), alt: 'Economy room', category: 'Rooms' },
  { src: img('hotel-rama-hindustani-jaipur-Economy Room-pic-42.jpg'), alt: 'Economy room', category: 'Rooms' },
  { src: img('hotel-rama-hindustani-jaipur-Standard room -pic-23.jpg'), alt: 'Standard room', category: 'Rooms' },
  { src: img('hotel-rama-hindustani-jaipur- standard room-pic-46.jpg'), alt: 'Standard room', category: 'Rooms' },
  { src: img('hotel-rama-hindustani-jaipur-Deluxe room-pic-28.jpg'), alt: 'Deluxe room', category: 'Rooms' },
  { src: img('hotel-rama-hindustani-jaipur-Delux room-pic-41.jpg'), alt: 'Deluxe room', category: 'Rooms' },
  { src: img('hotel-rama-hindustani-jaipur-Deluxe Room-pic-40.jpg'), alt: 'Deluxe room', category: 'Rooms' },
  { src: img('Super Deluxe room with fridge.jpg'), alt: 'Superior room', category: 'Rooms' },
  { src: img('Super Delux Room with Fridge 1.jpg'), alt: 'Superior room', category: 'Rooms' },
  { src: img('Super Deluxe room with Fridge 2.jpg'), alt: 'Superior room', category: 'Rooms' },
  { src: img('Super Deluxe room with fridge 4.jpg'), alt: 'Superior room', category: 'Rooms' },
  { src: img('hotel-rama-hindustani-jaipur-BathRoom-pic-44.jpg'), alt: 'Bathroom', category: 'Rooms' },
  { src: img('hotel-rama-hindustani-jaipur-BathRoom pic-45.jpg'), alt: 'Bathroom', category: 'Rooms' },
]
