...
const locations = [
  ...
  { icon: Building2, name: 'JECC - Convention Centre', distance: '4.9 km', detail: '7-9 min drive' },
  { icon: ShoppingBag, name: 'World Trade Park', distance: '6 km', detail: '12-15 min drive' },
  { icon: Landmark, name: 'Jawahar Circle & Patrika Gate', distance: '4.5 km', detail: '8-10 min drive' },
  { icon: Landmark, name: 'Chokhi Dhani', distance: '6.7 km', detail: '9-12 min drive' },
  ...
  { icon: Landmark, name: 'Hawa Mahal', distance: '18 km', detail: '25-35 min drive' },
  { icon: Landmark, name: 'Amber Fort & Palace', distance: '28 km', detail: '40-50 min drive' },
  { icon: Landmark, name: 'City Palace & Jantar Mantar', distance: '16 km', detail: '25-30 min drive' },
  { icon: Landmark, name: 'Birla Mandir', distance: '14 km', detail: '20-25 min drive' },
