...
const routes = [
  {
    path: '/',
    title: 'Hotel Rama Hindustani — Best Budget Hotel in Pratap Nagar Jaipur',
    description: 'Book Hotel Rama Hindustani in Pratap Nagar Jaipur near Airport, JECC, and Sanganer Railway Station. Budget family hotel with AC rooms, free WiFi, free parking, and vegetarian restaurant. Direct booking with best price guarantee.',
  ...
  {
    path: '/rooms',
    title: 'Hotel Rooms in Pratap Nagar Jaipur | Economy, Standard, Deluxe & Superior | Hotel Rama Hindustani',
    description: 'Explore room options at Hotel Rama Hindustani in Pratap Nagar Jaipur — Economy, Standard, Deluxe, and Superior Double Rooms with AC, WiFi, and modern amenities. Starting from ₹1,155/night.',
    keywords: 'Hotel Rooms in Pratap Nagar Jaipur, Budget AC Rooms Near Jaipur Airport, Economy Room Jaipur, Deluxe Room Pratap Nagar, Hotel Rooms Near JECC',
  ...
  {
    path: '/restaurant',
    title: 'Rama Rasoi Vegetarian Restaurant Pratap Nagar Jaipur | Indian Thali',
    description: 'Rama Rasoi vegetarian restaurant at Hotel Rama Hindustani in Pratap Nagar Jaipur. Authentic Indian cuisine, breakfast, lunch, dinner. Pure veg restaurant near Jaipur Airport.',
    keywords: 'Vegetarian Restaurant Pratap Nagar Jaipur, Rama Rasoi Jaipur, Pure Veg Restaurant Near Airport, Indian Thali Restaurant Pratap Nagar',
  ...
  },
  {
    ...
    keywords: 'Book Hotel Pratap Nagar Jaipur, Direct Hotel Booking Best Price, Hotel Near Airport Online Booking, Budget Hotel Booking Jaipur',
    ogImage: '/hotel-ramahindustani-image/hotel-rama-hindustani-jaipur-front-pic-4.avif',
    schema: 'bookNow',
  },
  {
