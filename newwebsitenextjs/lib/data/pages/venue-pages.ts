...
export const mountainViewDestinationPageData: MountainVenuePageData = {
  ...
  intro: {
    ...
    body:
      "The Mountain Resort in Karjat , By Redwings offers lush natural surroundings, valley views, open lawns, and a peaceful destination setting ideal for weddings, photography, rituals, and private event celebrations hosted in one estate.",
  },
  cards: [
    {
      label: "HIGHLIGHT",
  ...
  gallery: {
    title: "Venue Gallery",
    images: [
      { src: "https://bookonelocal.in/cdn/DSC08831.avif", alt: "Mountain landscape view" },
      { src: "https://bookonelocal.in/cdn/DSC08837.avif", alt: "Wedding lawn setup area" },
      { src: "https://bookonelocal.in/cdn/DSC08849.avif", alt: "Poolside mountain-facing venue" },
      { src: "https://bookonelocal.in/cdn/DSC08853.avif", alt: "Scenic venue destination corner" },
    ],
  },
  experienceJourney: [
    {
...
export const privateEventSpacesPageData: MountainVenuePageData = {
  ...
  intro: {
    ...
    body:
      "The Mountain Resort in Karjat , By Redwings includes dedicated venue areas for Haldi, Mehendi, Sangeet, Cocktail Night, wedding ceremonies, receptions, and family gatherings so every event can be hosted with comfort, privacy, and smooth movement across the property.",
  },
  cards: [
    {
      label: "SPACE",
  ...
  gallery: {
    ...
    images: [
      { src: "https://bookonelocal.in/cdn/DSC08837.avif", alt: "Private event space overview" },
      { src: "https://bookonelocal.in/cdn/DSC08849.avif", alt: "Cocktail and poolside event zone" },
      { src: "https://bookonelocal.in/cdn/DSC08846.avif", alt: "Private gathering area" },
      { src: "https://bookonelocal.in/cdn/DSC08769.avif", alt: "Celebration venue space" },
    ],
  },
  experienceJourney: [
    {
...
export const weddingLawnsPageData: MountainVenuePageData = {
  ...
  gallery: {
    ...
    images: [
      { src: "https://bookonelocal.in/cdn/DSC08831.avif", alt: "Wedding lawn view" },
      { src: "https://bookonelocal.in/cdn/DSC08837.avif", alt: "Ceremony lawn setup" },
      { src: "https://bookonelocal.in/cdn/DSC08849.avif", alt: "Evening lawn ambience" },
      { src: "https://bookonelocal.in/cdn/DSC08853.avif", alt: "Outdoor celebration area" },
    ],
  },
  experienceJourney: [
    {
...
export const poolsideCelebrationsPageData: MountainVenuePageData = {
  ...
  gallery: {
    ...
    images: [
      { src: "https://bookonelocal.in/cdn/DSC08849.avif", alt: "Poolside venue view" },
      { src: "https://bookonelocal.in/cdn/DSC08769.avif", alt: "Poolside guest area" },
      { src: "https://bookonelocal.in/cdn/DSC08853.avif", alt: "Evening poolside mood" },
      { src: "https://bookonelocal.in/cdn/DSC08837.avif", alt: "Poolside celebration setup" },
    ],
  },
  experienceJourney: [
    {
