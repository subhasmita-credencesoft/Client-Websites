      ...
      <section className="mx-auto grid max-w-[96rem] gap-16 px-8 pb-20 pt-8">
        {visibleOffers.map((offer, index) => {
          ...
          return (
            <article
              key={offer.title}
              className="grid items-start overflow-hidden rounded-[2rem] border border-[#c89a55]/18 bg-[#e9e5de] shadow-[0_24px_50px_rgba(10,18,12,0.14)] md:grid-cols-2"
              data-card
            >
              <div className={textFirst ? "order-1 bg-[#ece8e1] p-8 md:order-1 md:p-12" : "order-2 bg-[#ece8e1] p-8 md:order-2 md:p-12"}>
                <p className="text-xs font-semibold uppercase tracking-[0.28em] text-[#b88948]">Package Overview</p>
                <h3 className="mt-4 text-3xl leading-[1.15] text-[#1b201d] md:text-4xl" data-section-title>
                  {offer.title}
                </h3>
                <div className="mt-4 h-[2px] w-20 bg-[#c89a55]" />
                <p className="mt-7 text-lg leading-[1.7] text-[#232826] md:text-[1.35rem]">{offer.description}</p>
                <ul className="mt-8 grid gap-4 text-base leading-[1.7] text-[#202523] md:text-lg">
                ...
                <div className="mt-8 rounded-[1.5rem] border border-[#c89a55]/20 bg-white/55 px-5 py-5">
                  <p className="text-xs font-semibold uppercase tracking-[0.24em] text-[#b88948]">Pricing Note</p>
                  <p className="mt-3 text-base leading-[1.7] text-[#232826] md:text-lg">{contactLine}</p>
                </div>
                <Link
