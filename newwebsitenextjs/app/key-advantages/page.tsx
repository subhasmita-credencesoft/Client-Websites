...
import { keyAdvantagesPageData } from "@/lib/data/mountain-info-pages";
      ...
      <section className="relative min-h-[110svh] overflow-hidden pt-44 md:pt-48" data-section-id={page.slug}>
        ...
        <div className="relative z-10 mx-auto flex min-h-[110svh] max-w-[96rem] items-start px-6 pb-8 pt-28 md:px-12 md:pb-12 md:pt-36">
          <div className="max-w-5xl" data-panel-content>
            ...
            <p className="mt-5 max-w-4xl text-xl text-white/90 md:text-2xl" data-panel-line>
              {page.hero.subtitle}
            </p>
          ...
          {page.cards.map((card, index) => (
            ...
            >
              <div className="relative h-[26rem] overflow-hidden">
                ...
                <div className="absolute inset-x-0 bottom-0 h-28 bg-gradient-to-t from-[#0a0d0d] via-[#0a0d0d]/55 to-transparent" />
              </div>
