...
import { offersCards, stayCardsPrimary, stayCardsSecondary } from "@/lib/data/content/mountain-content";
                  ...
                  <div className="mt-4 rounded-[1.05rem] border border-white/10 bg-[#2d463b] px-4 py-3.5">
                    <div className="grid gap-x-6 gap-y-3 md:grid-cols-2">
                      ...
                      <div className="md:col-span-2">
                        ...
                        <p className="mt-1 text-sm text-white/86">{selectedOffer || "Standard booking enquiry"}</p>
                      </div>
                    </div>
                  </div>
                </div>
